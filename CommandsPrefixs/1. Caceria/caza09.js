...
module.exports = {
  ...
  */
  async execute(message, args, interaction) {
    ...
    // Embed
    const caza09_embed = new EmbedBuilder()
      // Titulo
      .setTitle("*Noceros*")

      // Imagen
      .setImage("https://cdn-longterm.mee6.xyz/plugins/embeds/images/638754973433331712/de88b784e416695c00337d8e556c43402459b57a9e905d083d67a9fae11cbc02.png")
    ...
    try {
      await message.author.send({ embeds: [caza09_embed] });
      // Borrar el mensaje
