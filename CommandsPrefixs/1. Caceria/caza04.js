...
module.exports = {
	...
	*/
	async execute(message, args, interaction) {
		// Embed
		const caza04_embed = new EmbedBuilder()
			.setTitle("*SaberFang*")
			.setColor("#000080")
			.setImage("https://cdn-longterm.mee6.xyz/plugins/embeds/images/638754973433331712/1d955a2e132d1be7523ee2a7ceda6c38b9260094d36247162d95051136c97929.png")
			.setAuthor({
