...
module.exports = {
  ...
  */
  async execute(message, args, interaction) {
    ...
    // Embed
    const caza23_embed = new EmbedBuilder()
      // Titulo
      .setTitle("*Terrospin*")

      // Imagen
      .setImage("https://cdn-longterm.mee6.xyz/plugins/embeds/images/638754973433331712/d013b759ebaff34fbf856919fb5489b2cea0b24bc2580e7eb95a8780acc50b54.png")
    ...
    try {
      await message.author.send({ embeds: [caza23_embed] });
      // Borrar el mensaje
